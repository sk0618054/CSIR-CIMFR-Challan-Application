...
class SPFormDataView extends StatefulWidget {
  final String formId;

  SPFormDataView( {required this.formId});

  @override
  State<SPFormDataView> createState() => _SPFormDataViewState();
}

class _SPFormDataViewState extends State<SPFormDataView> {
        ...
        actions: <Widget>[
          IconButton(
            ...
            onPressed: (){
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) =>  SPEditFormPage(initialData: formDataout?.toJson(),)),
              );
            },
          ),
          IconButton(
            ...
            onPressed: ()async{
              ...
              Navigator.pushReplacement( context, MaterialPageRoute( builder: (context) => AllFormViewPage()), ).then((value) => setState(() {}));
              setState(() {
                _isLoding=false;
              });
            },
