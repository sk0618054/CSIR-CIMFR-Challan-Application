...
import 'cp_edit_form_screen.dart';

class CPFormDataViewPrint extends StatefulWidget {
  final String formId;

  CPFormDataViewPrint({required this.formId});

  @override
  State<CPFormDataViewPrint> createState() => _CPFormDataViewPrintState();
}

class _CPFormDataViewPrintState extends State<CPFormDataViewPrint> {
  CPFormData? formDataout;
  bool _isLoding = false;

  Future<Uint8List> generatePdf(CPFormData formData) async {
  ...
  pw.Widget buildHeader(pw.MemoryImage logo, CPFormData formData) {
    return pw.Row(
  ...
  pw.Widget buildProjectInfo(CPFormData formData) => pw.Column(
    crossAxisAlignment: pw.CrossAxisAlignment.start,
    children: [
  ...
  pw.Widget buildTable(CPFormData formData) {
  ...
  pw.Widget buildRemarksAndSignature(CPFormData formData) => pw.Column(
    crossAxisAlignment: pw.CrossAxisAlignment.start,
    children: [
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        CPEditFormPage(initialData: formDataout?.toJson())),
              );
            },
          ),
          IconButton(
