...
class CPEditFormPage extends StatefulWidget {
  final Map<String, dynamic>? initialData;

  CPEditFormPage({required this.initialData});

  @override
  _CPEditFormPageState createState() => _CPEditFormPageState();
}

class _CPEditFormPageState extends State<CPEditFormPage> {
  ...
  void _submitForm() async {
    ...
    if (_formKey.currentState!.validate()) {
      try {
        ...
        await FirebaseFirestore.instance.collection("cpForm").doc(widget.initialData!['formId']).update(formData.toJson());
        // if (res == "success") {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Consultancy Project Form'),
      ),
