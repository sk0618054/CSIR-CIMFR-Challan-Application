...
class CPFormPage extends StatefulWidget {
  @override
  _CPFormPageState createState() => _CPFormPageState();
}

class _CPFormPageState extends State<CPFormPage> {
...
@override
  void initState() {
    ...
    super.initState();
    projectTypeController.text="CONSULTANCY";
  }
  ...
  void _submitForm() async {
    ...
    try {
      String res = await FirestoreMethods().cpFormUpload(
        nameController.text,
